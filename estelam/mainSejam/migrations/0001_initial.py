# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-09-10 12:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debt_clearance_date', models.DateField()),
                ('about', models.TextField()),
                ('gone_bad', models.BooleanField(default=False)),
                ('record_link', models.CharField(max_length=30)),
                ('relation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainSejam.CustomerInfo')),
            ],
        ),
        migrations.CreateModel(
            name='PermanentlyInfo',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(max_length=100)),
                ('last_name', models.CharField(max_length=100)),
                ...
                ('business_license_due_date', models.DateField()),
                ...
                ('b_sheba_num', models.BigIntegerField()),
                ...
                ('acount_type', models.CharField(default='base', max_length=10)),
                ('acount_upgrade_date', models.DateField()),
                ('gone_bad_records', models.BigIntegerField()),
            ],
        ),
        migrations.CreateModel(
            name='RegisteredRecords',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('gone_bad', models.BooleanField(default=False)),
                ('record_link', models.CharField(max_length=30)),
                ('relation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainSejam.PermanentlyInfo')),
            ],
        ),
        migrations.CreateModel(
            name='State',
        ...
        migrations.AddField(
            ...
            name='relation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainSejam.PermanentlyInfo'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='city',
            name='relation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainSejam.State'),
        ),
    ]
